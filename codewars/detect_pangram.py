...
def main():
    print(is_pangram_alt("The quick brown fox jumps over the lazy dog."))
    print(is_pangram_alt("This is not a pangram."))
    print(is_pangram_alt("The quick brown fox jumps over the lazy dog."))
    print(is_pangram_alt("Cwm fjord bank glyphs vext quiz"))
    print(is_pangram_alt("Pack my box with five dozen liquor jugs."))
    print(is_pangram_alt("How quickly daft jumping zebras vex."))
    print(is_pangram_alt("ABCD45EFGH,IJK,LMNOPQR56STUVW3XYZ"))
    print(is_pangram_alt("This isn't a pangram!"))
    print(is_pangram_alt("abcdefghijklm opqrstuvwxyz"))
    print(is_pangram_alt("Aacdefghijklmnopqrstuvwxyz"))
